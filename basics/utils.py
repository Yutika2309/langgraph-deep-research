...
class State(TypedDict):
    '''
        ...
        - message_type is going to be 'emotional' or 'logical'
    '''
    messages: Annotated[list, add_messages]
    message_type: str | None 

# creating a pydantic schema (STRUCTURED OUTPUT PARSER) to parse the output from the classifier as - emotional or logical
